...
- **Render Voxel Kinerja Tinggi**: Menggunakan WebGPU untuk merender ribuan instance kubus dengan teknik _Greedy Meshing_.
- **Arsitektur Berbasis ECS**: Menggunakan `bitecs` dengan alokasi _TypedArray_ pradefinisi (`growableComponent`) untuk mencegah kebocoran memori.
- **Multithreading**: Pembuatan chunk dan meshing dilakukan secara _asynchronous_ melalui Web Workers.
