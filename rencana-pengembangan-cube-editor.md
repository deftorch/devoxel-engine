...
- [ ] **Belum dikerjakan — konfigurasi umum lebih luas:** permintaan "proyek ini dirancang agar user bisa mengkonfigurasi berbagai hal" masih terlalu luas cakupannya untuk langsung dieksekusi (bisa berarti: default ukuran kubus, palet warna, sensitivitas kamera/scroll-zoom, warna grid, dll — masing-masing perlu keputusan desain sendiri soal di mana UI-nya, apakah persisten lewat localStorage, dsb). Perlu diskusi lebih lanjut untuk mempersempit cakupan sebelum dieksekusi, supaya tidak salah sasaran.
