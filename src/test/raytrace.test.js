import { COMPUTE_SHADER } from '../core/renderer/webgpu/raytrace.wgsl.js';
...
export async function runShadowTests() {
  ...
  try {
    ...
    assertCloseTo(
      radiance[shadowVoxelIdx],
      1.0,
      0.1,
      'Test 2: Lantai tepat di bawah balok harus terang (bayangan telah bergeser)'
    );
    ...
    if (foundFraction) {
      ...
      log(
        '[!] Test 3: Tidak menemukan nilai fraksional. (Wajar karena Cone Radius = 0.02 mungkin terlalu tipis untuk chunk 8x8)',
        'yellow'
      );
    }
